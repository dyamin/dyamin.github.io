...
- Tried and blocked from an agent session: creating `dyamin/dyamin` (GitHub integration returns 403 on repo creation) and the Pages "Enforce HTTPS" setting (Pages API not reachable through the proxy).
